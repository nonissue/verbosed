  ...
  return (
    <Box
      backgroundImage={`url("data:image/svg+xml,%3Csvg preserveAspectRatio='none' viewBox='0 0 500 500' xmlns='http://www.w3.org/2000/svg' width='100%25' id='blobSvg'%3E%3Cdefs%3E%3ClinearGradient id='gradient' x1='0%25' y1='0%25' x2='0%25' y2='100%25'%3E%3Cstop offset='0%25' style='stop-color: rgba(45, 55, 72, ${
        ...
        0.3 / svgOpacity
      });'%3E%3C/stop%3E%3C/linearGradient%3E%3C/defs%3E%3Cpath id='blob' d='M393,298.5Q327,347,276.5,351.5Q226,356,133.5,353Q41,350,97,276.5Q153,203,184.5,151.5Q216,100,271.5,127Q327,154,393,202Q459,250,393,298.5Z' fill='none' stroke-width='1px' stroke='url(%23gradient)'%3E%3C/path%3E%3C/svg%3E"), url("data:image/svg+xml,%0A%3Csvg viewBox='0 0 500 500' xmlns='http://www.w3.org/2000/svg' width='100%25' id='blobSvg'%3E%3Cdefs%3E%3ClinearGradient id='gradient' x1='0%25' y1='0%25' x2='0%25' y2='100%25'%3E%3Cstop offset='0%25' style='stop-color: rgba(45, 55, 72, ${
        0.1 / svgOpacity
      });'%3E%3C/stop%3E%3Cstop offset='100%25' style='stop-color: rgba(74, 85, 104,${
        0.4 / svgOpacity
      });'%3E%3C/stop%3E%3C/linearGradient%3E%3C/defs%3E%3Cpath id='blob' d='M387,282.5Q302,315,266,326.5Q230,338,182,322Q134,306,106.5,237Q79,168,155.5,170Q232,172,265,181Q298,190,385,220Q472,250,387,282.5Z' fill='none' stroke-width='1px' stroke='url(%23gradient)'%3E%3C/path%3E%3C/svg%3E"), url("data:image/svg+xml,%3Csvg viewBox='0 0 500 500' xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='none' width='100%25' id='blobSvg'%3E%3Cdefs%3E%3ClinearGradient id='gradient' x1='0%25' y1='0%25' x2='0%25' y2='100%25'%3E%3Cstop offset='0%25' style='stop-color: rgba(45, 55, 72, ${
        0.3 / svgOpacity
      });'%3E%3C/stop%3E%3Cstop offset='100%25' style='stop-color: rgba(74, 85, 104, ${
        0.1 / svgOpacity
      ...
      backgroundSize={["250% 100%", "contain"]}
      width="100vw"
      height="100%"
    >
      <Flex
